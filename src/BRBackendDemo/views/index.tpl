...
<head>
  ...
  <link rel="apple-touch-icon-precomposed" href="/static/img/app-icon72x72@2x.png">
  ...
  <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
        ...
        <li><a href="discover.html"><span class="am-icon-file"></span>发现排序</a></li>
        <li><a href="secret-bookshelf.html"><span class="am-icon-table"></span>秘密书架</a></li>
        <li><a href="book-list.html"><span class="am-icon-pencil-square-o"></span>书单接口</a></li>
        ...
        <div class="am-panel am-panel-default">
          ...
          <div id="collapse-panel-2" class="am-in">
            <table class="am-table am-table-bd am-table-bdrs am-table-striped am-table-hover">
              ...
              <tr>
                <td class="am-text-center"><img src="/static/img/admin-chrome.png" alt=""></td>
                <td>Google Chrome</td>
                <td>3,005</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="/static/img/admin-firefox.png" alt=""></td>
                <td>Mozilla Firefox</td>
                <td>2,505</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="/static/img/admin-ie.png" alt=""></td>
                <td>Internet Explorer</td>
                <td>1,405</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="/static/img/admin-opera.png" alt=""></td>
                <td>Opera</td>
                <td>4,005</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="/static/img/admin-safari.png" alt=""></td>
                <td>Safari</td>
                <td>505</td>
              </tr>
              </tbody>
